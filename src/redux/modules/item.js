...
// //     return function(dispatch, getState, {navigate}){
// //         const increment = is_like ? db.firestore.FieldValue.increment(-1) : db.firestore.FieldValue.increment(1);
// //         const users = is_like ? db.firestore.FieldValue.arrayRemove(user_id) : db.firestore.FieldValue.arrayUnion(user_id);
